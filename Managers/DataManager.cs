...
namespace ClinicAppointmentSystem
{
    public static class DataManager
    {
        ...
        private static readonly ClinicAppointmentSystem.Services.JsonDataService _jsonService = new ClinicAppointmentSystem.Services.JsonDataService();
        ...
        {
            // Reset doctors to remove low-quality placeholders (rr, r, ddd, etc)
            Doctors.Clear();

            var clinicalStaff = new List<Doctor> {
                new Doctor { Id = 1, FullName = "Dr. Elena Rodriguez", Specialty = "Cardiology", Department = "Cardiology", IsActive = true, WorkingDays = "Mon,Tue,Wed,Thu,Fri", WorkingHoursStart = new TimeSpan(8,0,0), WorkingHoursEnd = new TimeSpan(16,0,0) },
                new Doctor { Id = 2, FullName = "Dr. Marcus Thorne", Specialty = "Orthopedics", Department = "Orthopedics", IsActive = true, WorkingDays = "Mon,Tue,Wed,Fri", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(17,0,0) },
                new Doctor { Id = 3, FullName = "Dr. Sarah Jenkins", Specialty = "Pediatrics", Department = "Pediatrics", IsActive = true, WorkingDays = "Mon,Wed,Fri", WorkingHoursStart = new TimeSpan(10,0,0), WorkingHoursEnd = new TimeSpan(16,0,0) },
                new Doctor { Id = 4, FullName = "Dr. Robert Chen", Specialty = "Neurology", Department = "Neurology", IsActive = true, WorkingDays = "Tue,Thu,Sat", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(17,0,0) },
                new Doctor { Id = 5, FullName = "Dr. Aisha Patel", Specialty = "Dermatology", Department = "Dermatology", IsActive = true, WorkingDays = "Mon,Tue,Thu,Fri", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(17,30,0) },
                new Doctor { Id = 6, FullName = "Dr. Thomas Miller", Specialty = "General Medicine", Department = "General Medicine", IsActive = true, WorkingDays = "Mon,Wed,Fri", WorkingHoursStart = new TimeSpan(8,30,0), WorkingHoursEnd = new TimeSpan(16,30,0) },
                new Doctor { Id = 7, FullName = "Dr. Linda Zhao", Specialty = "Internal Med", Department = "General Medicine", IsActive = true, WorkingDays = "Tue,Wed,Fri", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(17,0,0) },
                new Doctor { Id = 8, FullName = "Dr. Kevin Brooks", Specialty = "Psychiatry", Department = "Psychiatry", IsActive = true, WorkingDays = "Mon,Thu,Sat", WorkingHoursStart = new TimeSpan(10,0,0), WorkingHoursEnd = new TimeSpan(18,0,0) },
                new Doctor { Id = 10, FullName = "Dr. Sophia Walsh", Specialty = "Gynecology", Department = "Gynecology", IsActive = true, WorkingDays = "Mon,Tue,Wed,Fri", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(15,0,0) },
                new Doctor { Id = 11, FullName = "Dr. David Kim", Specialty = "Dental Care", Department = "Dental", IsActive = true, WorkingDays = "Mon,Wed,Fri", WorkingHoursStart = new TimeSpan(8,0,0), WorkingHoursEnd = new TimeSpan(17,0,0) },
                new Doctor { Id = 12, FullName = "Dr. Angela Hope", Specialty = "ENT Surgery", Department = "ENT", IsActive = true, WorkingDays = "Tue,Thu,Sat", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(17,0,0) },
                new Doctor { Id = 13, FullName = "Dr. James Carter", Specialty = "General Medicine", Department = "General Medicine", IsActive = true, WorkingDays = "Mon,Tue,Wed,Thu,Fri", WorkingHoursStart = new TimeSpan(9,0,0), WorkingHoursEnd = new TimeSpan(18,0,0) }
            };
        ...
        public static User AuthenticateUser(string username, string password)
        {
            ...
            if (user != null && ClinicAppointmentSystem.Utils.PasswordHasher.VerifyPassword(password, user.Password))
            {
                CurrentUser = user;
                return user;
            }
        ...
        public static void RegisterPatient(Patient patient)
        {
            ...
            Users.Add(new User { Id = Users.Any() ? Users.Max(u => u.Id) + 1 : 1, Username = patient.Phone, Password = ClinicAppointmentSystem.Utils.PasswordHasher.HashPassword(patient.Password), Role = "Patient", PatientId = patient.Id, IsActive = true });
