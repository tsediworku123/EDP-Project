...
namespace ClinicAppointmentSystem.Models
{
    public class Doctor
    {
        ...
        public DateTime DateOfBirth { get; set; } // Changed to DateTime for consistency
        public string Address { get; set; }     // Added for Full Info
        ...
        public string CalendarColor { get; set; } = "#2196F3"; // Material Blue default
